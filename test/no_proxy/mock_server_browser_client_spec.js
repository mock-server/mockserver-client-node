if ((typeof __karma__ !== 'undefined' ? __karma__.config.mode === 'no_proxy' : window.location.href.indexOf('proxy=true') === -1)) {
  ...
  describe("mockServerClient client:", function () {
    ...
    // possible not possible to test this scenario due
    // to browser restriction on cross-domain cookies
    ...
    it("should retrieve some expectations using object matcher", function (done) {
      // when
      client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
        .then(function () {
          client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
    ...
    it("should retrieve some expectations using path", function (done) {
      // when
      client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
        .then(function () {
          client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
    ...
    it("should retrieve all expectations using object matcher", function (done) {
      // when
      client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
        .then(function () {
          client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
    ...
    it("should retrieve all expectations using null matcher", function (done) {
      // when
      client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
        .then(function () {
          client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
    ...
    it("should retrieve all requests using object matcher", function (done) {
      // given
      client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
        .then(function () {
          client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
    ...
    it("should retrieve all requests using null matcher", function (done) {
      // given
      client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
        .then(function () {
          client.mockSimpleResponse('/somePathOne', {name: 'one'}, 201)
